...
CREATE TABLE pokemon_blog_trends (
...
-- 인덱스 추가 (검색 속도 향상)
CREATE INDEX idx_pokemon_blog_trends_date ON pokemon_blog_trends(date);
CREATE INDEX idx_pokemon_blog_trends_keyword ON pokemon_blog_trends(keyword);
