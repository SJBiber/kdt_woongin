...
*   **데이터 볼륨**: 네이버 블로그 두쫀쿠 및 **과거 유행 키워드(탕후루, 요아정 등)** 포스트 업로드량, 유튜브 키워드 업로드량 및 일별 조회수, 구글 트랜드 및 네이버 키워드 검색량.
...
*   **분석 쿼리 로직**:
    ...
    - **벤치마크 비교(Benchmark Analysis)**: 탕후루, 요아정 등 과거 유행 사례의 유행 지속 기간 및 감쇠 패턴과의 유사성 분석.
