# [개발 구축서] 마라샹궈 네이버 블로그 검색 데이터 수집 시스템

## 1. 프로젝트 개요
- **목적**: '마라샹궈' 키워드에 대한 네이버 블로그 검색 결과 수를 정기적으로 수집하여 트렌드 분석 지표로 활용.
...
| **5단계** | **데이터 자동화** (다중 키워드 수집 및 일별 로그 저장 자동화) | **완료** (`crawler.py`, `mara_counts.csv`, `mara_trends` 연동) |
